	...
	function (Controller) {
		...
		return Controller.extend("ns.Lists.controller.ListTypes", {
            ...
            onShowSelectedRows: function () {
                var stadardList = this.getView().byId("stadardList");
                var selectedItems = stadardList.getSelectedItems();
            ...
            onDeleteRows: function () {
                ...
                if (selectedItems.length === 0){
                    ...
                    stadardList.removeSelections();
                    sap.m.MessageToast.show(textMessage);
                }
            },

            onDeletethisRow: function (oEvent) {
                var i18nModel= this.getView().getModel("i18n").getResourceBundle();
                var textMessage = i18nModel.getText("selectedRow");
                ...
                let actualRow = indexSelectedRow;
                ++actualRow;
                textMessage = textMessage + ':' + actualRow;
                sap.m.MessageToast.show(textMessage);
                model.refresh();
            }
		});
